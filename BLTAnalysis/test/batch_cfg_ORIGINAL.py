...
if period == '2016':
	...
	############  DATA
	if selection == "mumug":
		data_samples += ['double_mu_2018Reco']
	elif selection == "elelg":
		data_samples += ['double_el_2018Reco']
	elif selection == 'ee':
		data_samples += ['single_el_2018Reco']
	elif selection == 'mumu':
		data_samples += ["single_mu_2018Reco"]
	
	############  MC
	if selection == "mumug":
		#mc_samples += ['JC_ZG_ZToLL_2018Reco']
		mc_samples += ['JC_WJets_2018Reco']
		#mc_samples += ['JC_DYJets_2018Reco']
		#mc_samples += ['JC_WZ_2018Reco','JC_ZZ_2018Reco','JC_WW_2018Reco']
		mc_samples += ['JC_TT_2018Reco']
	elif selection == "elelg":
		#mc_samples += ['JC_ZG_ZToLL_2018Reco']
		#mc_samples += ['JC_WJets_2018Reco']
		#mc_samples += ['JC_DYJets_2018Reco']
...
############################################## SAMPLES 2018 ##########################################################
######################################################################################################################
path = '/eos/uscms/store/user/lpcbacon/corderom/data_2018/DoubleMuon/'
