...
#   hadd    z1jets_m-10to50_1.root  output_DY1JetsToLL_M-10to50_*.root
#   hadd    z2jets_m-10to50_1.root  output_DY2JetsToLL_M-10to50_*.root
#   hadd    z3jets_m-10to50_1.root  output_DY3JetsToLL_M-10to50_*.root
#   hadd    z4jets_m-10to50_1.root  output_DY4JetsToLL_M-10to50_*.root
...
#   hadd    z2jets_m-50_1.root      output_DY2JetsToLL_M-50_1.root  output_DY2JetsToLL_M-50_2.root
...
#   hadd    z3jets_m-50_1.root      output_DY3JetsToLL_M-50_*.root
#   hadd    z4jets_m-50_1.root      output_DY4JetsToLL_M-50_*.root
...
## Move to EOS
#   for suffix in "dy_m-10to50" "dy_m-50" "z1jets_m-10to50" "z1jets_m-50" "z2jets_m-10to50" "z2jets_m-50" "z3jets_m-10to50" "z3jets_m-50" "z4jets_m-10to50" "z4jets_m-50" "ggH_zz_4l" "H_zz_4l" "ttbar" "ttz_2l2nu" "ww_2l2nu" "wz_3lnu" "zz_4l"
    for suffix in "electron_2016" "muon_2016"
    do
