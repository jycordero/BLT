...
void makeSmearElectronHZZ()
{
    ...
    TString inPath = "/uscms/home/jrainbol/nobackup/CMSSW_8_0_26_patch1/src/BLT/BLTAnalysis/data/electron_id/";
    TFile *inFile = TFile::Open(inPath + "hzz_electron_id_sf.root");
    TH2 *h_err;
    inFile->GetObject("EGamma_SF2D", h_err);
