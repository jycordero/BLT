...
class zAnalyzerTrig: public BLTSelector {
public:
    zAnalyzerTrig();
    ~zAnalyzerTrig();
    ...
    Bool_t ProbeIDPass, ProbeISOPass, ProbeSigPass, ProbeWorstPass;
    Bool_t ProbeTrigPass, ProbeTrigMu17Pass, ProbeTrigMu8Pass, ProbeTrigMu17LegPass,  ProbeTrigMu8LegPass;
    Bool_t ProbeGlobalTrigMu17Pass, ProbeGlobalTrigMu8Pass;
    ...
    TH2F *PhotonProbe;
    TH2F *PhotonProbeIDPass, *PhotonProbeIDFail;
    TH2F *PhotonProbeISOPass, *PhotonProbeISOFail;
    TH2F *PhotonProbeSigPass, *PhotonProbeSigFail;
    TH2F *PhotonProbeWorstPass, *PhotonProbeWorstFail;

    TH2F *MuonProbe;
    TH2F *MuonProbeIDISOPass, *MuonProbeIDPass;
    TH2F *MuonProbeIDISOFail, *MuonProbeIDFail;

    //ClassDef(zAnalyzerTrig,0);
};
